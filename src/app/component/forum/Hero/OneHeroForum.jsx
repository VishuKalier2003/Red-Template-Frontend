...
const OneHeroForm = () => {
    const { heroKey, heroType, addHero, deleteHero } = HeroConsumer();
    ...
    return (
        <div className="relative w-full h-full flex flex-col">
            ...
            <form onSubmit={handleSubmit}>
                <div>
                    <label className="relative mb-[1rem] ml-[6px] mr-[6px] pl-[4px] text-[0.75rem] md:text-[1rem] w-[18vw] poppins-regular">Image Link</label>
                    <input className="relative back-black-light fore-white poppins-light ml-[6px] mr-[6px] pl-[4px] text-lg md:text-xl w-[18vw] rounded-lg mb-[1rem]"
                        type="text"
                        value={heroData.heroLink}
                        placeholder=""
                        onChange={(e) => setHeroData({ ...heroData, heroLink: e.target.value })}
                    />
                </div>
                <div>
